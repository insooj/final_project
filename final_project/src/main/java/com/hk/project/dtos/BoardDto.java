...
public class BoardDto {
	...
	public BoardDto(int board_seq, String id, String title, String content, String mdate, Date regdate, String delflag,
			int price, int sold, String sold_id, List<FileBoardDto> fileBoardDto) {
		super();
	...
	public BoardDto(int board_seq, String id, String title, String content, String mdate, Date regdate, String delflag,
			int price, int sold, List<FileBoardDto> fileBoardDto) {
		super();
		this.board_seq = board_seq;
		this.id = id;
		this.title = title;
	...
	public String toString() {
		return "BoardDto [board_seq=" + board_seq + ", id=" + id + ", title=" + title + ", content=" + content
				+ ", mdate=" + mdate + ", regdate=" + regdate + ", delflag=" + delflag + ", price=" + price + ", sold="
				+ sold + ", sold_id=" + sold_id + ", fileBoardDto=" + fileBoardDto + "]";
	}
