...
//@Data
@Alias(value = "boardDto") //mapper.xml 에서 사용하는 변수명 설정
public class BoardDto {
	...
	public BoardDto(int board_seq, String id, String title, String content, Date regdate, String delflag,String role,
	...
	public String toString() {
		return "BoardDto [board_seq=" + board_seq + ", id=" + id + ", title=" + title + ", content=" + content
				+ ", regdate=" + regdate + ", delflag=" + delflag + ", role=" + role + ", fileBoardDto=" + fileBoardDto
				+ ", getRole()=" + getRole() + ", getBoard_seq()=" + getBoard_seq() + ", getId()=" + getId()
				+ ", getTitle()=" + getTitle() + ", getContent()=" + getContent() + ", getRegdate()=" + getRegdate()
				+ ", getDelflag()=" + getDelflag() + ", getFileBoardDto()=" + getFileBoardDto() + ", getClass()="
