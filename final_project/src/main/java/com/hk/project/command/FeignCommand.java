...
public class FeignCommand {
	...
	private List<UserAccountDto> res_list;
	...
	public FeignCommand(String api_tran_id, String api_tran_dtm, String rsp_code, String rsp_message,
			String user_seq_no, String user_ci, String user_name, String user_info, String user_gender,
			String user_cell_no, String user_email, String res_cnt, List<UserAccountDto> res_list) {
		super();
		this.api_tran_id = api_tran_id;
	...
	public List<UserAccountDto> getRes_list() {
		return res_list;
	}

	public void setRes_list(List<UserAccountDto> res_list) {
		this.res_list = res_list;
	}
